...
[분석 대상 기획 — 이 내용을 기준으로 유사작품을 찾아야 해]
장르: ${genre} | 플랫폼: ${platLabel} | 목표화수: ${ep}
기획 내용:
${concept}

[유사작품 선정 기준 — 반드시 준수]
유사작품은 아래 기준 중 2개 이상 해당해야 해. 장르만 같으면 안 돼:
- 핵심 소재/설정이 비슷 (예: 같은 직업·세계관·능력 시스템)
- 주인공 성격·성장 방식이 유사
- 주요 갈등 구조·테마가 겹침
- 타깃 독자층이 같음
- 플랫폼·포맷·분위기가 유사

전혀 다른 소재의 작품은 언급하지 마. 반드시 위 기준으로 실제 존재하는 웹툰/만화만 추천해.
